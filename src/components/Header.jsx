...
//                 <span className="font-semibold text-gray-500 text-sm">Recipe Categories</span>
//               </div>
              
//               <span className="font-small text-xs font-semibold border border-gray-300 rounded-full px-2 py-1">1.6K</span>
//               </div>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>Video Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>A-Z Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>This Week's Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>Contact Us</span>
//             </div>
...
//               <div className="flex items-center">
//                 <div className="w-9 h-9 bg-red-500 rounded-md flex items-center justify-center mr-2">
//                   <svg
//                   className="w-5 h-5 sm:w-7 sm:h-7 lg:w-8 lg:h-8 text-white"
//                   fill="currentColor"
//                   viewBox="0 0 24 24"
//                 >
...
//                 </svg>
//                 </div>
//                 <span className="text-3xl font-bold text-red-500">Platea</span>
//               </div>
//             {/* </div> */}
...
//                     className="text-gray-800 hover:text-red-500 text-lg tracking-tighter font-semibold flex items-center py-2"
//                   >
//                     Home
...
//                 <Search size={20} />
//               </button>
//               <button className="bg-gray-200 hover:bg-gray-300 text-black px-4.5 py-2.5 font-semibold tracking-tighter rounded-md text-sm font-medium">
//                 Add Recipe
//               </button>
//             </div>
...
//               <span className="font-small text-xs font-semibold border border-gray-300 rounded-full px-2 py-1">1.6K</span>
//               </div>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter hidden lg:inline'>Video Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter hidden lg:inline'>A-Z Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>This Week's Recipes</span>
//               <span className='text-gray-400 font-semibold text-sm tracking-tighter'>Contact Us</span>
//             </div>
...
//                 <span className="font-semibold text-gray-500 text-sm">Categories</span>
