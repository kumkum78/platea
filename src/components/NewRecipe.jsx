  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="relative flex flex-col items-center mb-10 py-6">
        ...
        <h2 className="text-4xl font-bold text-gray-900 z-10 mb-4">New Recipes</h2>
        <p className="text-lg text-black z-10 text-center max-w-2xl">
          Explore our latest recipes, from quick snacks to hearty meals and indulgent desserts.
        </p>
      </div>
...
<div className="flex flex-wrap gap-2 justify-center mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {filteredRecipes.map((recipe) => (
          <div key={recipe.id} className="bg-white rounded-xl overflow-hidden shadow hover:shadow-lg transition-shadow duration-200">
            {/* Image Container */}
            <div className="relative">
              ...
              <div className="absolute top-3 right-3 flex flex-col space-y-2">
                ...
                >
                  <Heart size={16} fill={recipe.liked ? 'currentColor' : 'none'} />
                </button>
                <button
                ...
                >
                  <Bookmark size={16} fill={recipe.bookmarked ? 'currentColor' : 'none'} />
                </button>
              </div>
            </div>
            {/* Content */}
            <div className="p-6">
              {/* Category */}
              <div className="mb-3">
                <span className="text-xs font-medium text-red-500 uppercase tracking-wide">{recipe.category}</span>
              </div>
              {/* Title */}
